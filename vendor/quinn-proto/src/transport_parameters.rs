...
impl TransportParameters {
    pub(crate) fn new(
        ...
        Self {
            ...
            .into(),
            // Hysteria 2 / quic-go clients fragment only when this TP is ~1200.
            // Quinn originally advertised datagram_receive_buffer_size (tens of KB),
            // which lets official 2.8.1 queue a 1424-byte datagram that never packs.
